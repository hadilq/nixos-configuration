...
let
  cfg = config.hardware.system76.darp9;

  # Allow silencing the warning about these options if either is defined.
  soundSettingsDefined =
    options.hardware.system76.darp9.soundVendorId.isDefined ||
    options.hardware.system76.darp9.soundSubsystemId.isDefined;
...
in
{
  ...
  options.hardware.system76.darp9 = {
